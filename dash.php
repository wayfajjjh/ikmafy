...
<title> Admin || STAI YAPATA Al-Jawami</title>
...
if (@$_GET['q'] == 2)
    echo 'class="active"';
?>><a href="dash.php?q=2">Daftar hasil</a></li>

        <li <?php
if (@$_GET['q'] == 4)
    echo 'class="active"';
?>><a href="dash.php?q=4">Tambah Soal</a></li>
        <li <?php
if (@$_GET['q'] == 5)
    echo 'class="active"';
?>><a href="dash.php?q=5">Remove Soal</a></li>
        <li <?php
if (@$_GET['q'] == 6)
    echo 'class="active"';
?>><a href="dash.php?q=6">Soal Angket</a></li>
      </ul>
          </div>
  </div>
</nav>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Masukan Judul Soal" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="total" name="total" placeholder="Masukan Jumlah Soal" class="form-control input-md" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="right" name="right" placeholder="Nilai Pada Jawaban Yang Benar" class="form-control input-md" min="0" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="wrong" name="wrong" placeholder="Nilai Pada Jawaban Yang Salah" class="form-control input-md" min="0" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="time" name="time" placeholder="Masukan Time Limit" class="form-control input-md" min="1" type="number">
...
<div class="reset" id="reset">
    ...
    <input  type="text" id="angket" name="angket"  style="width: 50%;
    padding: 12px 20px;
    margin: 8px 0;
    ...
    <br>
    <input name="submit" id="submit" class="submit" type="submit" value="Tambah" style="  width: 15%;
      ...
      border-radius: 4px;
      cursor: pointer;"" >
      <div class="hasil_nya" id="hasil_nya">
      </div>
...
$('#hasil_nya').load("hasil_angket.php");
$("#submit").on('click', function() {
  if(confirm('Menambah pertanyaan dalam angket dapat menghapus seluruh nilai di angket dan peserta, akankah anda menambah pertanyaan angket ?'))
{

    var angket = $("#angket").val();
    if(angket==''){
      $('#peringatan').html('<small style="color:red;">*Tidak Boleh Kosong</small>');
      $('#peringatan').show(1000);


    }else{
      $('#reset').load("reset.php");
